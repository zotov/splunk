...
@Component
@Scope("prototype")
public class UpdateRecNumMunSerFI extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecNumMunSerFI.class);
	...
	public void updateInvoice() {
		...
		try {			 
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceSerFI(InvoiceNum.class, id, delay);
