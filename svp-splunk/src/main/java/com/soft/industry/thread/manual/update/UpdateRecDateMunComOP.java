...
@Component
@Scope("prototype")
public class UpdateRecDateMunComOP extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecDateMunComOP.class);
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceComOP(InvoiceDate.class, id,delay);
