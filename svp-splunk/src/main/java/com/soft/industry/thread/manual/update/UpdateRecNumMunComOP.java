...
@Component
@Scope("prototype")
public class UpdateRecNumMunComOP extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecNumMunComOP.class);
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceComOP(InvoiceNum.class, invoice.getId(),delay);
