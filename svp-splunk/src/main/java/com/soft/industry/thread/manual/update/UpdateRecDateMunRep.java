...
@Component
@Scope("prototype")
public class UpdateRecDateMunRep extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecDateMunRep.class);
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceRep(InvoiceDate.class, id,delay);
