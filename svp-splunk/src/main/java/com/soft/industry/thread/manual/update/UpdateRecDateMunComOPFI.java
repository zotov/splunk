...
@Component
@Scope("prototype")
public class UpdateRecDateMunComOPFI extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecDateMunComOPFI.class);
	...
	public UpdateRecDateMunComOPFI() {
		super.log= log;
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceComOPFI(InvoiceDate.class, id,delay);
