...
@Component
@Scope("prototype")
public class UpdateRecMunRep extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecMunRep.class);
	...
	public void updateInvoice() {
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceRep(InvoiceEnt.class, invoice.getId(),delay);
