...
@Component
@Scope("prototype")
public class UpdateRecUn extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecUn.class);
	...
	public void updateInvoice() {
		...
		try {
		    Invoice invoiceChanged = invoiceAnnotDao.updateInvoiceUn(invoice.getClass(),id,delay);
