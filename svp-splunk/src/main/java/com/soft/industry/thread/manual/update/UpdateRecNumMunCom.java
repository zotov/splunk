...
@Component
@Scope("prototype")
public class UpdateRecNumMunCom extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecNumMunCom.class);
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceCom(InvoiceNum.class, invoice.getId(),delay);
