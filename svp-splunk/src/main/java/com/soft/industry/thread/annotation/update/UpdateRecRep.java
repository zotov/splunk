...
@Component
@Scope("prototype")
public class UpdateRecRep extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecRep.class);
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceAnnotDao.updateInvoiceRep(invoice.getClass(), id,delay);
