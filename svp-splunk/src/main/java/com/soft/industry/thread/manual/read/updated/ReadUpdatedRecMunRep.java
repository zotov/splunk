...
@Component
@Scope("prototype")
public class ReadUpdatedRecMunRep extends ReadRec {

	private static final Logger log = LoggerFactory.getLogger(ReadUpdatedRecMunRep.class);
	...
	private void readRecordUpdated() {
		 final Invoice readInvoice = this.invoice;
			 ...
			 Thread t3 = new Thread(new Runnable() {
				@Override
				public void run() {
			        Invoice invoice = invoiceDaoManualImpl.getInvoiceByIdRep(readInvoice.getClass(),(int)getInvoice().getId());
