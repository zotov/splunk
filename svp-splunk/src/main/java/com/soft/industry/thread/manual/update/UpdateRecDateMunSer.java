...
@Component
@Scope("prototype")
public class UpdateRecDateMunSer extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecDateMunSer.class);
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceSer(InvoiceDate.class, id,delay);
