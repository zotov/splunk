...
@Component
@Scope("prototype")
public class ReadUpdatedRecMunCom extends ReadRec {

	private static final Logger log = LoggerFactory.getLogger(ReadUpdatedRecMunCom.class);
	...
	private void readRecordUpdated() {
		 final Invoice readInvoice = this.invoice;
		     ...
		     Thread t1 = new Thread(new Runnable() {
				@Override
				public void run() {
			        Invoice invoice = invoiceDaoManualImpl.getInvoiceByIdCom(readInvoice.getClass(),(int)getInvoice().getId());
