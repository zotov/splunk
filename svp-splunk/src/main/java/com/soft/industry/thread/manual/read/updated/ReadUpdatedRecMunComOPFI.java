...
@Component
@Scope("prototype")
public class ReadUpdatedRecMunComOPFI extends ReadRec {

	private static final Logger log = LoggerFactory.getLogger(ReadUpdatedRecMunComOPFI.class);
	...
	public ReadUpdatedRecMunComOPFI() {
		super.log = log;
	...
	private void readRecordUpdated() {
		 final Invoice readInvoice = this.invoice;
		     ...
		     Thread t1 = new Thread(new Runnable() {
				@Override
				public void run() {
			        Invoice invoice = invoiceDaoManualImpl.getInvoiceByIdComOPFI(readInvoice.getClass(),(int)getInvoice().getId());
