...
@Component
@Scope("prototype")
public class ReadUpdatedRecMunUn extends ReadRec {

	private static final Logger log = LoggerFactory.getLogger(ReadUpdatedRecMunUn.class);
	...
	private void readRecordUpdated() {
		 final Invoice readInvoice = this.invoice;
		     ...
		     Thread t1 = new Thread(new Runnable() {
				@Override
				public void run() {
			        Invoice invoice = invoiceDaoManualImpl.getInvoiceByIdUn(readInvoice.getClass(),(int)getInvoice().getId());
