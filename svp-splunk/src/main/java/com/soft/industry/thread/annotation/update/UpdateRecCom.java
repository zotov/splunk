...
@Component
@Scope("prototype")
public class UpdateRecCom extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecCom.class);
	...
	public void updateInvoice() {
		...
		try {
		     Invoice invoiceChanged = invoiceAnnotDao.updateInvoiceCom(invoice.getClass(), id,delay);
