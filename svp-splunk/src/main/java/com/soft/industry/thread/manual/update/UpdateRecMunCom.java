...
@Component
@Scope("prototype")
public class UpdateRecMunCom extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecMunCom.class);
	...
	public void updateInvoice() {
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceCom(InvoiceEnt.class, invoice.getId(),delay);
