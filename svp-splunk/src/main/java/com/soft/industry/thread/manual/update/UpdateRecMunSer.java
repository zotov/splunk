...
@Component
@Scope("prototype")
public class UpdateRecMunSer extends UpdateRec {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateRecMunSer.class);
	...
	public void updateInvoice() {
		try {
		     Invoice invoiceChanged = invoiceDaoManualImpl.updateInvoiceSer(InvoiceEnt.class, invoice.getId(),delay);
